...
const Landing = () => {
  return (
    <div
      className="flex flex-col justify-center items-center bg-metalic-img h-[100vh]"
      id="LANDING"
    >
      <div className="flex flex-col justify-center w-full px-4 lg:w-[35%]">
        ...
        <a
          href="/mint"
          className="text-white py-4 cursor-pointer mt-10 w-[50%] md:w-1/4 font-poppins bg-black flex justify-center rounded-lg  hover:bg-white hover:text-black hover:border border-black"
        >
      ...
      <div className="hidden md:block index-2 absolute bottom-[30px] right-[60px]">
        {SocialLinks.map((lnk) => {
          return (
            <div
              key={lnk.title}
              className="my-10 hover:scale-150 hover:opacity-100 duration-500 opacity-50"
            >
              <a
                href={lnk.link}
                rel="noreferrer"
